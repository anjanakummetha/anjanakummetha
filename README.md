...
- **[ecoSnap](https://github.com/anjanakummetha/EcoSnap)** Gamified recycling app with Gemini AI image classification. HopperHacks 2026 Sustainability Track Winner. React · Three.js.

## Tools I work with

`Python` `TypeScript` `JavaScript` `Java` `SQL` · `Claude API` `Gemini API` `MCP` `RAG` `scikit-learn` · `React` `Next.js` `FastAPI` · `PostgreSQL` `SQLite` `GitHub Actions` `Linux`

anjanakummetha@gmail.com
